@echo off
REM Installation script for Install_WingetApp.ps1 using Microsoft Intune Win32 apps

REM Declare the Winget AppID variable. 
REM IMPORTANT: Replace 'YourAppID' with the actual AppID of the Winget application you want to install.
...
REM Execute the PowerShell script with the specified Winget AppID for installation.
